#ifndef SLIC3R_EDGEGRID_H
#define SLIC3R_EDGEGRID_H
...
public:
    ...
    // Get all model objects as one BoudingBox. TODO @Samir document.
    ///
    /// \param bbox
...
protected:
    ...
    BoundingBox 								m_bbox; ///< Bounding box around the contours.
